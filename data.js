// ============================================================
//  data.js — Complete 180-Day Roadmap Data
// ============================================================
  ...
  },
  {
    ...
    weeks_data: [
      ...
      },
      {
        ...
        days: [
          { day:'Mon', learn:'React Router v6: routes, useNavigate, useParams, Outlet',        build:'Set up routing for a multi-page app' },
...
const QUOTES = [
  ...
  "A typical CS degree is 1,200–1,500 hours. You're doing the equivalent in 9 months — with better projects.",
