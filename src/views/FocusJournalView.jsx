  ...
  return (
    <div style={{ padding: '0 40px 60px' }}>
      ...
      <div className="focus-journal-layout" style={{ display: 'grid', gridTemplateColumns: '1.3fr 1fr', gap: '24px' }}>
        ...
        {/* LEFT PANEL: Curriculum syllabus & daily checklists */}
        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          
          {/* DAILY CURRICULUM TARGETS (Top of Left Panel) */}
          {currentDayData ? (
          ...
          {/* Daily Checklist (Bottom of Left Panel) */}
          <div className="card" style={{ padding: '22px' }}>
        ...
        {/* RIGHT PANEL: Pomodoro Focus Timer, Soundscapes & Journal Notes (Bottom of Right Panel) */}
        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          ...
          {/* Notes Area Editor (Journal Notes - Bottom of Right Column) */}
          <div className="card" style={{ padding: '22px' }}>
